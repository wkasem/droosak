...
return [
    ...
    */
    ...
    'url' => env('APP_URL', 'https://droosak.com'),
    ...
    */
    ...
    'aliases' => [
        ...
        'Streamer' => droosak\Helpers\Streamer::class,
        'Dates' => droosak\Helpers\Dates::class,
        'Exam' => droosak\Helpers\Exam::class,
        'Conversation' => droosak\Helpers\Conversation::class,
        'Payment' => droosak\Helpers\Payment::class,
        'Points' => droosak\Helpers\Points::class,
        'Dacast' => Dacast\Api::class,
